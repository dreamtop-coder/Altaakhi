(function(){
    ...
    window.recomputeTotals = function(){
        try{
            // services total
            var svcTotal = 0;
            document.querySelectorAll('#services-body .service-row').forEach(function(r){ try{ var val = parseFloat(r.querySelector('.service-amount').value)||0; svcTotal += val; }catch(e){} });
