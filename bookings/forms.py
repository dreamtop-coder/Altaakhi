...
class BookingForm(forms.ModelForm):
    plate_number = forms.CharField(
        label='رقم السيارة',
        required=True,
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'أدخل رقم السيارة'})
    )
    ...
    def clean(self):
        ...
        try:
            ...
            raise forms.ValidationError('لا يوجد سيارة بهذا الرقم، يرجى تسجيل السيارة أولاً.')
