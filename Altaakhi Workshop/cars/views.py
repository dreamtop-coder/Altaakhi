...
# Models and forms (move common imports to top to satisfy linters)
...
def bookings_clients(request):
    ...
    bookings = (
        Booking.objects.select_related("car").filter(status="pending").order_by("-service_date")
    )
...
def maintenance_list(request):
    # MaintenanceRecord imported at module top
...
# تعديل سجل صيانة
# MaintenanceRecord, MaintenanceRecordForm and shortcuts imported at module top
