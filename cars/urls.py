...
urlpatterns = [
    ...
    path('maintenance/edit/<int:record_id>/', views.edit_maintenance_record, name='edit_maintenance_record'),
    path('maintenance/edit-fields/<int:record_id>/', views.edit_maintenance_record_fields, name='edit_maintenance_record_fields'),
    ...
    path('cars/change_status/<int:car_id>/', views.change_status, name='change_status'),
    path('cars/start/<int:car_id>/', views.start_maintenance, name='start_maintenance'),
    path('cars/finish/<int:car_id>/', views.finish_maintenance, name='finish_maintenance'),
    path('cars/collect/<int:car_id>/', views.mark_collected, name='mark_collected'),

    # AJAX filter endpoint for dashboard car status
    path('cars/ajax/filter/', cars_ajax_filter, name='cars_ajax_filter'),
    path('cars/ajax/bookings_clients/', views.bookings_clients, name='bookings_clients'),
